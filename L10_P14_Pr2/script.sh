...
#copiamos fuselib.c y myfs a temp y a mount-point
...
if diff mount-point/fuseLib.c temp/fuseLib.c
then echo "Los ficheros son iguales"
else echo "Los ficheros son diferentes"
fi

#modificamos tamaño de fiselib en ambos lugares
echo "modificando el tamaño de fuseLib en mount-point y temp"
truncate mount-point/fuseLib.c -s -3
...
cp fichero1.txt mount-point/fichero1.txt

echo "Mostramos diferencias del fichero1"
if diff mount-point/fichero1.txt fichero1.txt
then echo "Los ficheros son iguales"
else echo "Los ficheros son diferentes"
fi

#modificamos tamaño de myFS en temp y mount-point
echo "modificando el tamaño myFS en mount-point y temp"
truncate mount-point/myFS.h -s +3
truncate temp/myFS.h -s +3
echo "Mostrando diferencias del fichero fuseLib.c"
if diff mount-point/myFS.h temp/myFS.h
then echo "Los ficheros son iguales"
else echo "Los ficheros son diferentes"
fi

echo "Viendo lo que hay en la carpeta mount-point"
ls -la mount-point
